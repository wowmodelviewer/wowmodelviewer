#define _TEXTUREBLP_CPP_
#include "TextureBLP.h"
#undef _TEXTUREBLP_CPP_
...
void TextureBLP::decompressDXTC(GLint format, int w, int h, size_t size, unsigned char *src, unsigned char *dest)
{
