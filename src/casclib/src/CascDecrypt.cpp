...
//  ----------------------  ------------------------------------------------------------------------------------------------     -----------
    ...
    {0xB7DBC693758A5C36ULL, {0xBC, 0x3A, 0x92, 0xBF, 0xE3, 0x02, 0x51, 0x8D, 0x91, 0xCC, 0x30, 0x79, 0x06, 0x71, 0xBF, 0x10}},   // 1.5.0.1.32795 Genji Oni skin (HotS Nexus Challenge)
    ...
    {0xF432F0425363F250ULL, {0xBA, 0x69, 0xF2, 0xB3, 0x3C, 0x27, 0x68, 0xF5, 0xF2, 0x9B, 0xFE, 0x78, 0xA5, 0xA1, 0xFA, 0xD5}},   // 1.10.0.0.35455 cmf Uprising
    {0x061D52F86830B35DULL, {0xD7, 0x79, 0xF9, 0xC6, 0xCC, 0x9A, 0x4B, 0xE1, 0x03, 0xA4, 0xE9, 0x0A, 0x73, 0x38, 0xF7, 0x93}},   // 1.10.0.0.35455 cmf D.Va Officer Skin (HotS Nexus Challenge 2)
...
//  {0x094E9A0474876B98ULL, {0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??, 0x??}},   // 92  WOW-23910patch7.2.5_PTR
    ...
    {0x0ADC9E327E42E98CULL, {0x01, 0x7B, 0x34, 0x72, 0xC1, 0xDE, 0xE3, 0x04, 0xFA, 0x0B, 0x2F, 0xF8, 0xE5, 0x3F, 0xF7, 0xD6}},   // 99
    {0, {0}}
};
