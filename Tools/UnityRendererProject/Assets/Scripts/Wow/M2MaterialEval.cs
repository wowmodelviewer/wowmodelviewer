...
namespace Wmv.Wow
{
    ...
    public struct M2MaterialState
    {
        ...
        public bool Drawn;
        /// <summary>Unit 0 / unit 1 have a transform bound whose translation or scale has keys here.</summary>
        public bool Uv0Applied, Uv1Applied;
        /// <summary>WoW-space translation and scale per unit; (0,0) and (1,1) when not applied.</summary>
        public float T0x, T0y, S0x, S0y, T1x, T1y, S1x, S1y;
        ...
        public static M2MaterialState Identity
        {
            get
            {
                ...
                s.R = s.G = s.B = 1f;
                s.OcolW = 1f; s.EcolW = 0f; s.Weight = 1f;
                s.S0x = s.S0y = s.S1x = s.S1y = 1f;
                return s;
            }
        }
    }
    ...
    public static class M2MaterialEval
    {
        ...
        /// are indices into model.Colors, model.TextureWeightTracks and model.TextureTransforms,
        /// or -1 when the batch has none (STATIC and environment units arrive here as -1).
        /// </summary>
        public static void Evaluate(M2ParsedModel m, int color, int weight, int xf0, int xf1,
                                    float t, double globalTimeMs, ref M2MaterialState s,
