...
set(Qt5VulkanSupport_VERSION_STRING 5.13.2)
...
if (NOT TARGET Qt5::VulkanSupport)
    ...
    set(Qt5VulkanSupport_PRIVATE_INCLUDE_DIRS
        "${_qt5VulkanSupport_install_prefix}/include/QtVulkanSupport/5.13.2"
        "${_qt5VulkanSupport_install_prefix}/include/QtVulkanSupport/5.13.2/QtVulkanSupport"
    )
    ...
    foreach(_module_dep ${_Qt5VulkanSupport_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.13.2 ${_Qt5VulkanSupport_FIND_VERSION_EXACT}
