...
#        define _WDC2FILE_API_ __declspec(dllexport)
#    else
#        define _WDC2FILE_API_ __declspec(dllimport)
#    endif
#else
...
public:
	struct header
	{
		...
		// new to WDC2, this is number of sections of data (records + copy table + id list + relationship map = a section)
	};
