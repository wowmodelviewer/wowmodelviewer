...
SettingsControl::SettingsControl(wxWindow* parent, wxWindowID id)
{
	...
	if (Create(parent, id, wxDefaultPosition, wxSize(405, 550), wxDEFAULT_FRAME_STYLE,
	           wxT("SettingsControlFrame")) == false)
	{
	...
	//
	notebook = new wxNotebook(this, ID_SETTINGS_TABS, wxPoint(0, 0), wxSize(400, 550),
	                          wxNB_TOP | wxNB_FIXEDWIDTH | wxNB_NOPAGETHEME);
