...
GeneralSettings::GeneralSettings(wxWindow* parent, wxWindowID id)
{
	...
	chkbox[CHECK_SHOWPARTICLE] = new wxCheckBox(this, ID_SETTINGS_SHOWPARTICLE, _("Show Particle"), wxDefaultPosition,
	                                            wxDefaultSize, 0);
	chkbox[CHECK_ZEROPARTICLE] = new wxCheckBox(this, ID_SETTINGS_ZEROPARTICLE, _("Zero Particle"), wxDefaultPosition,
	                                            wxDefaultSize, 0);
	chkbox[CHECK_RANDOMSKIN] = new wxCheckBox(this, ID_SETTINGS_RANDOMSKIN, _("Random Skins"), wxDefaultPosition,
	                                          wxDefaultSize, 0);
	chkbox[CHECK_DISPLAYIDINLIST] = new wxCheckBox(this, ID_SETTINGS_DISPLAYIDINLIST,
	                                               _("Display Items/NPCs' IDs in lists"), wxDefaultPosition,
	                                               wxDefaultSize, 0);
	...
	customDirectoryPathDisplay = new wxTextCtrl(this, wxID_ANY, customMsg, wxDefaultPosition, wxSize(300, -1),
	                                            wxTE_READONLY);
	top->AddSpacer(2);
	...
	top->Add(new wxButton(this, ID_FIND_GAME_FOLDER, _("Change Game Folder"), wxDefaultPosition, wxDefaultSize, 0), 0,
	         wxALL, 5);
	top->AddSpacer(2);
	top->Add(new wxStaticLine(this, wxID_ANY), 1, wxEXPAND);
	top->AddSpacer(2);
	top->Add(new wxStaticText(this, wxID_ANY, _("Custom / Imported Files"), wxDefaultPosition, wxDefaultSize, 0), 0,
	         wxALL, 5);
	top->Add(customDirectoryPathDisplay, 0, wxALL, 5);
	wxFlexGridSizer* gbox = new wxFlexGridSizer(2, 5, 5);
	gbox->Add(new wxButton(this, ID_FIND_CUSTOM_FOLDER, _("Select Custom Folder"), wxDefaultPosition, wxDefaultSize,
	                       0));
	...
	top->AddSpacer(2);
	top->Add(new wxButton(this, ID_GENERAL_SETTINGS_APPLY, _("Apply"), wxDefaultPosition, wxDefaultSize, 0), 0, wxALL,
	         5);
