...
WDC2File::WDC2File(const std::string& file): WDB5File(file), m_header()
{
}
...
bool WDC2File::readFieldValue(unsigned int recordIndex, unsigned int fieldIndex, uint arrayIndex, uint arraySize,
